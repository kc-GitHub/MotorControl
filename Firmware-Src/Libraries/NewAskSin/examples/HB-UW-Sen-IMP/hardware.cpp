...
/**
 * @brief Initialize the wake up pin.
 */
...
/**
 * @brief To enable the USB port for upload, configure PE2 as input
 *        and check if it is 0. This will avoid sleep mode and
 *        enable program upload via serial port.
 */
